...
The Game Boy's CPU, the Zilog Z80-like Sharp LR35902, is interesting in that in bundles computational abilities and audio synthesis abilities. Its audio synthesizer is controlled by writing to a small region of the Game Boy's memory. For the sake of discussion, I'll call the Z80-like computational bit the CPU and the rest the audio unit.
...
<img src="{{ page.imgDir }}/wip-2.png" alt="Ostrich WIP, part 2" style="width: 60%; ">
<p></p>
